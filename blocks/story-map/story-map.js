		...
		callback: function () {
			...
			function mapInit() {
				...
				$.each(storyMap.places, function (i, item) {
					$(".story-map__content-" + item.category + " .story-map__places").append('<li class="story-map__place-item"><a data-href="'
							+ i + '"><img class="story-map__place-thumb later-lazy" data-src="img/thumb-' + item.image + '">' +
							item.title +
							'</a></li>');
					...
					var infowindow = new google.maps.InfoWindow({
						content: "<h3 class='story-map__label-title'>" + item.title + "</h3>" + item.description +
						"<img class='story-map__label-image' data-src='img/" + item.image + "' data-index='" + i + "'>"
					});
					...
					google.maps.event.addListener(marker, 'click', function () {
						for (var x = 0; x < arrInfoWindows.length; x++) {
							...
							// Lazy-загружаем изображение балуна
			...
			$(function () {
				...
				$(".story-map__places a").on("click", function (e) {
					...
					$(this).addClass('story-map__place--active');
